                ...
                <tr>
                    ...
                    <td>
                        <form action="" method="post" class="header-search">
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Rechercher le nom ou l'email du patient" list="patient">&nbsp;&nbsp;
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows == 0) {
                                    ...
                                    <a class="non-style-link" href="patient.php"><button class="login-btn btn-primary-soft btn" style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Montrer tous les Patients &nbsp;</button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        Voici les détails du patient sélectionné.
                                    </p>
                                </td>
                            </tr>
                            <tr>
