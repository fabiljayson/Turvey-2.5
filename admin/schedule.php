            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-schedule menu-active menu-icon-schedule-active">
                        <a href="schedule.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Horaire</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style="border-spacing: 0;margin:0;padding:0;margin-top:25px;">
                <tr>
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Gestion de l'Horaire</p>
                    </td>
                    <td width="15%">
                ...
                <tr>
                    <td colspan="4">
                        <div style="display: flex;margin-top: 40px;">
                            <div class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49);margin-top: 5px;">Planifier une Séance</div>
                            <a href="?action=add-session&id=none&error=0" class="non-style-link"><button class="login-btn btn-primary btn button-icon" style="margin-left:25px;background-image: url('../img/icons/add.svg');">Ajouter une Séance</button></a>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Toutes les Séances (<?php echo $list110->num_rows; ?>)</p>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;">
                        ...
                        <select name="docid" id="" class="box filter-container-items" style="width:90%;height: 37px;margin: 0;">
                            <option value="" disabled selected hidden>Choisissez le nom du docteur dans la liste</option><br/>
                            <?php 
                   ...
                   <td colspan="4">
                       <center>
                        ...
                        <tr>
                                ...
                                <th class="table-headin">
                                    Nombre maximum pouvant être réservé
                                </th>
                                <th class="table-headin">
                                    Événements
                                </th>
    ...
    if ($_GET) {
        ...
        if ($action == 'add-session') {
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="docid" class="form-label">Sélectionner un Docteur : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                        ...
                        echo '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nop" class="form-label">Nombre de Patients/Nombre de Rendez-vous : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="number" name="nop" class="input-text" min="0" placeholder="Le nombre final de rendez-vous pour cette séance dépend de ce nombre" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="time" class="form-label">Heure de la Séance : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <input type="submit" value="Planifier cette Séance" class="login-btn btn-primary btn" name="shedulesubmit">
                                </td>
                            </tr>
                            </form>
                            </tr>
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>Séance Planifiée.</h2>
                        <a class="close" href="schedule.php">&times;</a>
                        <div class="content">
                        '.substr($titleget, 0, 40).' a été planifiée.<br><br>
                        </div>
                        <div style="display: flex;justify-content: center;">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nic" class="form-label">Date Planifiée : </label>
                                </td>
                            </tr>
<tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Tele" class="form-label">Heure Planifiée : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
